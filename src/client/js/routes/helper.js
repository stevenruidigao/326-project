...
export const toggleElementAll = (
  ...
  els = els instanceof NodeList || Array.isArray(els)
            ? els
 ...
 * @param {string} className
 * @param {boolean | undefined} forceShow whether to add or remove the class -
 *     if undefined, simply toggles
 * @param {Element} parent
 */
...
export const setTitle = (title) => {
  document.title =
      [ title, title && " | ", "TutorSwap" ].filter(Boolean).join("");
};
