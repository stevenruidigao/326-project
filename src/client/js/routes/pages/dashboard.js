...
export default async (args, doc) => {
  ...
  // recent message for (const convoKey in conversations) {
  ...
  //  * Bypasses the pagination in the API since the API doesn't correctly sort
  //  appointments yet
  //  *
  //  * @returns {Promise<Appointment[]>} - A promise that resolves to the new
  //  appointment element.
  //  */
